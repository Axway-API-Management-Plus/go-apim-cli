...
**Url** | **string** | The URL of the authorization endpoint for the authentication code grant flow. The value should be in a URL format. | [optional] 
**ClientIdName** | **string** | An optional alternative name to standard \&quot;client_id\&quot; OAuth2 parameter. | [optional] 
**ClientSecretName** | **string** | An optional alternative name to standard \&quot;client_secret\&quot; OAuth2 parameter. | [optional] 
